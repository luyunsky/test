$(function () {
  ...
  //  当前指数名称
  var curZSName = "米袋子消费价格指数";
  // 当前指数指标代码
  var curZSCode = "ID01954379";
  var zhibiaoCodeList = [
    "ID01954379",
    "ID01954124",
    "ID01954118",
...
// 动态配置指标名称和代码
var zhibiaoConfig = [
  { name: "米袋子消费价格指数", code: "ID01954379" },
  { name: "面粉批发价格指数", code: "ID01954124" },
  { name: "面粉零售价值指数", code: "ID01954118" },
  { name: "大米批发价格指数", code: "ID01954131" },
  { name: "大米零售价格指数", code: "ID01954121" },
  { name: "小米批发价格指数", code: "ID01954132" },
  { name: "小米零售价格指数", code: "ID01954119" },
  { name: "绿豆批发价格指数", code: "ID01954135" },
  { name: "绿豆零售价格指数", code: "ID01954130" },
  { name: "玉米面批发价格指数", code: "ID01954120" },  
  { name: "玉米面零售价格指数", code: "ID01954133" }
];

  var zhibiaoYSCodeList = { 
    ID01954379: ["ID01954379","DE0017188896","DE0017188889"],
    ID01954124: ["ID01954124","DE0017188917","DE0017188916"],
    ID01954118: ["ID01954118","DE0017188905","DE0017188904"],
    ID01954131: ["ID01954131","DE0017188913","DE0017188912"],    
    ID01954121: ["ID01954121","DE0017188901","DE0017188900"],
    ID01954132: ["ID01954132","DE0017188919","DE0017188918"],
    ID01954119: ["ID01954119","DE0017188907","DE0017188906"],
    ID01954135: ["ID01954135","DE0017188915","DE0017188914"],
    ID01954130: ["ID01954130","DE0017188903","DE0017188902"],
    ID01954120: ["ID01954120","DE0017188921","DE0017188920"],
    ID01954133: ["ID01954133","DE0017188909","DE0017188908"]
  };
